...
<dd></dd>
<dt><a href="#ResponseGetFrameRates">ResponseGetFrameRates</a> : <code>Object</code></dt>
<dd></dd>
...
<dd></dd>
<dt><a href="#ResponseCancelApplication">ResponseCancelApplication</a> : <code>Object</code></dt>
<dd></dd>
...
* [Albis](#Albis)
    ...
    * [.getFrameRates(values, albisToken)](#Albis+getFrameRates) ⇒ [<code>ResponseGetFrameRates</code>](#ResponseGetFrameRates)
...
| [values.residualValuePercent] | <code>number</code> | Residual value percent (mandatory if contract type equals 11 (TA)) |
| [values.serviceFee] | <code>number</code> | service fee (mandatory if contract type equals 7 or 12) |
| [values.cntbw] | <code>number</code> | amount of black-white pages. Used if service/printers contract type (7 or 12) |
| [values.costbw] | <code>number</code> | cost of black-white pages per page. Used if service/printers contract type (7 or 12) |
| [values.cntclr] | <code>number</code> | amount of colour pages. Used if service/printers contract type (7 or 12) |
| [values.costclr] | <code>number</code> | cost of colour pages per page. Used if service/printers contract type (7 or 12) |
| [values.cntscan] | <code>number</code> | amount of scanned pages. Used if service/printers contract type (7 or 12) |
| [values.costscan] | <code>number</code> | cost of scanned pages per page. Used if service/printers contract type (7 or 12) |
| albisToken | <code>Object</code> | object with Albis token, which lets to communicate with Albis API |
...
```
<a name="Albis+getFrameRates"></a>

### albis.getFrameRates(values, albisToken) ⇒ [<code>ResponseGetFrameRates</code>](#ResponseGetFrameRates)
...
**Kind**: instance method of [<code>Albis</code>](#Albis)  
**Returns**: [<code>ResponseGetFrameRates</code>](#ResponseGetFrameRates) - response object  
...
| values.contractType | <code>number</code> | Contract type |
| values.paymentMethod | <code>number</code> | Payment options |
| [values.residualValueSum] | <code>number</code> | Residual value sum (mandatory if contract type equals 11 (TA)) |
| [values.residualValuePercent] | <code>number</code> | Residual value percent (mandatory if contract type equals 11 (TA)) |
| [values.serviceFee] | <code>number</code> | service fee (mandatory if contract type equals 7 or 12) |
| [values.cntbw] | <code>number</code> | amount of black-white pages. Used if service/printers contract type (7 or 12) |
| [values.costbw] | <code>number</code> | cost of black-white pages per page. Used if service/printers contract type (7 or 12) |
...
| [values.residualValuePercent] | <code>number</code> | required if contract type equals 11 (optional) |
...
| values.residualValuePercent | <code>number</code> | required if contract type equals 11 |
| albisToken | <code>Object</code> | object with Albis token, which lets to communicate with SDK API (returned from getAlbisToken() method) |
...
## ResponseGetFrameRates : <code>Object</code>
**Kind**: global typedef  
**Properties**
...
<a name="ResponseCancelApplication"></a>

## ResponseCancelApplication : <code>Object</code>
**Kind**: global typedef  
**Properties**
...
| response.id | <code>string</code> | json rpc lib id |
| response.jsonrpc | <code>string</code> | json rpc version number ("2.0") |
| response.result | <code>Array.&lt;Object&gt;</code> | array with objects like: {   subApplication: 987654,       applicationReceptionDate: "2021-06-01",       applicationStatus: 123,       lastUpdate: "2021-05-01",       object: "Fridge",       purchasePrice: 30000,       leaseTerm: 36,       rate": 35.50,       contractType": 1,       contractTypeTxt: "VA-Leasingvertrag",       terminationTerm: 12,       isInsurance: false,       hid400: 123456, - salesman id number       serviceFee: 0,       retailer: "EDEKABANK AG",       user: "Kris Henkel",       applicationStatusTxt: "Antrag genehmigt"} |
