...
class Albis {
  ...
  async albisPing(albisToken) {
    const endpoint = Object(_helpers__WEBPACK_IMPORTED_MODULE_2__["getEndpointPath"])('ping', this.apiStage, this.SDKendpoint);
    let res = {}
    try {
 ...
 async albisEcho(data, albisToken) {
  const endpoint = Object(_helpers__WEBPACK_IMPORTED_MODULE_2__["getEndpointPath"])('echo', this.apiStage, this.SDKendpoint);
  let res = {}
  try {
    res = await axios__WEBPACK_IMPORTED_MODULE_0___default.a.get(endpoint, {
      headers: {
...
async getContractDocuments(applicationId, albisToken) {
  const endpoint = Object(_helpers__WEBPACK_IMPORTED_MODULE_2__["getEndpointPath"])('contract-documents', this.apiStage, this.SDKendpoint);
  let res = {}
  try {
    res = await axios__WEBPACK_IMPORTED_MODULE_0___default.a.get(endpoint, {
      headers: { 
...
async changePassword(albisNewPassword, auth0NewPassword, albisToken) {
  const endpoint = Object(_helpers__WEBPACK_IMPORTED_MODULE_2__["getEndpointPath"])('password', this.apiStage, this.SDKendpoint);
  let res = {}
  try {
  ...
  async getLegalForms(albisToken) {
    const endpoint = Object(_helpers__WEBPACK_IMPORTED_MODULE_2__["getEndpointPath"])('legal-forms', this.apiStage, this.SDKendpoint);
    let res = {}
   ...
   */
    ...
    async getContractTypes(albisToken) {
      const endpoint = Object(_helpers__WEBPACK_IMPORTED_MODULE_2__["getEndpointPath"])('contract-types', this.apiStage, this.SDKendpoint);
      let res = {}
  ...
  async getProductGroups(albisToken) {
    const endpoint = Object(_helpers__WEBPACK_IMPORTED_MODULE_2__["getEndpointPath"])('product-groups', this.apiStage, this.SDKendpoint);
    let res = {}
   ...
   */
   ...
   async getPaymentMethods(albisToken) {
    const endpoint = Object(_helpers__WEBPACK_IMPORTED_MODULE_2__["getEndpointPath"])('payment-methods', this.apiStage, this.SDKendpoint);
    let res = {}
  ...
  async getApplicationsStatus(albisToken) {
    const endpoint = Object(_helpers__WEBPACK_IMPORTED_MODULE_2__["getEndpointPath"])('applications-status', this.apiStage, this.SDKendpoint);
    let res = {}
  ...
  async getSalutations(albisToken) {
    const endpoint = Object(_helpers__WEBPACK_IMPORTED_MODULE_2__["getEndpointPath"])('salutations', this.apiStage, this.SDKendpoint);
    let res = {}
   ...
   */
   ...
   async saveFrameSubApplication(values, albisToken) {
    const endpoint = Object(_helpers__WEBPACK_IMPORTED_MODULE_2__["getEndpointPath"])('frame-sub-application', this.apiStage, this.SDKendpoint);
    let res = {}
   ...
   */
   ...
   async findFrameSubApplications(frameApplicationId, showExternalStatus, albisToken) {
    const endpoint = Object(_helpers__WEBPACK_IMPORTED_MODULE_2__["getEndpointPath"])('frame-sub-applications', this.apiStage, this.SDKendpoint);
    let res = {}
    try {
      res = await axios__WEBPACK_IMPORTED_MODULE_0___default.a.get(endpoint, {
        headers: { 
  ...
  async logout(albisToken) {
    const endpoint = Object(_helpers__WEBPACK_IMPORTED_MODULE_2__["getEndpointPath"])('token', this.apiStage, this.SDKendpoint);
    let res = {}
