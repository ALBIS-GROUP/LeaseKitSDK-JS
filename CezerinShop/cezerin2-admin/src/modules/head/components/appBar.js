...
export default class AppBarTop extends React.Component {
	...
	render() {
		...
		} else if (pathname === '/settings/checkout/fields/legal_form') {
			title = messages.legal_form;
			leftButton = (
				<Link to="/settings/checkout">
					<IconButton>
						<FontIcon color="#fff" className="material-icons">
		...
		} else if (pathname === '/settings/checkout/fields/street') {
			title = messages.street;
			leftButton = (
				<Link to="/settings/checkout">
					<IconButton>
						<FontIcon color="#fff" className="material-icons">
		...
		} else if (pathname === '/settings/checkout/fields/fax') {
			title = messages.fax;
			leftButton = (
				<Link to="/settings/checkout">
					<IconButton>
