...
class CustomersService {
	...
	getValidDocumentForInsert(data) {
		...
		customer.fax = parse.getString(data.fax).toLowerCase();
		...
		customer.legal_form = parse.getString(data.legal_form);
	...
	createObjectToUpdateAddressFields(address) {
		...
		if (address.street !== undefined) {
			fields['addresses.$.street'] = parse.getString(address.street);
		}
